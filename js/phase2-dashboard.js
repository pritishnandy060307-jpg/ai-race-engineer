...
function addPanel() {
    ...
    section.innerHTML = `
        <div class="phase2-heading"><div><h2>Session Dashboard</h2><p class="calculator-description">Live session information and driver-focused session statistics.</p></div><span id="sessionHealth" class="session-health neutral">STANDBY</span></div>
        <div class="phase2-grid"><div class="phase2-card"><span>Driver</span><strong>Pritish Nandy</strong></div><div class="phase2-card"><span>Vehicle</span><strong>Formula Student Car</strong></div><div class="phase2-card"><span>Session Type</span><strong>Practice</strong></div><div class="phase2-card"><span>Current Sector</span><strong id="currentSector">—</strong></div></div>
        <div class="phase2-grid phase2-stats"><div class="phase2-card"><span>Top Speed</span><strong id="sessionTopSpeed">—</strong></div><div class="phase2-card"><span>Peak RPM</span><strong id="sessionPeakRpm">—</strong></div><div class="phase2-card"><span>Average Throttle</span><strong id="sessionAverageThrottle">—</strong></div><div class="phase2-card"><span>Braking Events</span><strong id="sessionBrakingEvents">0</strong></div></div>
...
function resetSession() {
    ...
    // Stop an active session once. Never click twice: that immediately starts and stops it again.
    if (active) sessionButton?.click();
